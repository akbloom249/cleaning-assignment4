...
The final data set contains one row for each combination of subject and activity, and 68 columns for the 66 selected features plus the subject and activity columns.  Thus, it will have 30 &times; 6 &times; 68 entries, or 12240 individual entries.
